...
$('.user-add-to-friends').click(function(e) {
    e.preventDefault();
    var id = $(this).data('id');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $('#user_' + id + '_friend_del').removeClass('btn-hide');
        }
    });
});

$('.user-del-from-friends').click(function(e) {
    e.preventDefault();
    var id = $(this).data('id');
    var selfId = $(this).attr('id');

    console.log('add '+id+' | #user_' + id + '_friend_add');
    $(this).addClass('btn-hide');
    $('#user_' + id + '_friend_add').removeClass('btn-hide');
});
